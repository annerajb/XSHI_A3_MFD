...
//    XHSIPreferences preferences;
    ...
    public EICASSubcomponent(ModelFactory model_factory, EICASGraphicsConfig eicas_gc) {
        super(model_factory, eicas_gc);

        this.eicas_gc = eicas_gc;
    ...
    public EICASSubcomponent(ModelFactory model_factory, EICASGraphicsConfig eicas_gc, Component parent_component) {
        this(model_factory, eicas_gc);
...
//        gImg.setRenderingHints(eicas_gc.rendering_hints);
