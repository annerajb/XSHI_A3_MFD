...
public class UH60MGraphicsConfig extends GraphicsConfig implements ComponentListener
{
    public int TAS_pos_y;
    public int TAS_r;
    ...
    public UH60MGraphicsConfig(Component root_component, int du) {
...
//    }
    ...
    public void update_config(Graphics2D g2) 
    {
        ...
        //if (this.resized|| this.reconfig)
        {
            ...
            adi_cx = this.panel_rect.x + this.panel_rect.width/2 - instrument_size*20/1000;
            adi_cy = panel_offset_y + this.panel_rect.y + instrument_size * 200 / 1000;
            ...
            instrument_size = Math.min(this.panel_rect.width, this.panel_rect.height);
            TAS_r = Math.min(instrument_size*9/100, panel_rect.width*9/100); 
            TAS_pos_y = panel_rect.y + instrument_size*17/100;
        }
