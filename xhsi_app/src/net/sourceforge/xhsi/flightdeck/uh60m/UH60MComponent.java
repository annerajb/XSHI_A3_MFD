...
import net.sourceforge.xhsi.flightdeck.empty.*;
...
import net.sourceforge.xhsi.flightdeck.pfd.ADI;
...
public class UH60MComponent extends Component implements Observer, PreferencesObserver {
    ...
    public UH60MComponent(ModelFactory model_factory, int du) {

        this.empty_gc = new UH60MGraphicsConfig(this, du);
        ...
        subcomponents.add(new DebugText(model_factory, empty_gc, this));
        subcomponents.add(new UH60ADI(model_factory, empty_gc, this));
    ...
    public Dimension getPreferredSize() {
        return new Dimension(UH60MGraphicsConfig.INITIAL_PANEL_SIZE + 2*UH60MGraphicsConfig.INITIAL_BORDER_SIZE, UH60MGraphicsConfig.INITIAL_PANEL_SIZE + 2*UH60MGraphicsConfig.INITIAL_BORDER_SIZE);
    }
...
//        g2.setComposite(ac);
        ...
        {
            if (UH60MComponent.COLLECT_PROFILING_INFORMATION) {
                time = System.currentTimeMillis();
            }

            // paint each of the subcomponents
            ((UH60MSubcomponent) this.subcomponents.get(i)).paint(g2);
        ...
        if (UH60MComponent.COLLECT_PROFILING_INFORMATION) 
        {
            if (this.nb_of_paints % UH60MComponent.NB_OF_PAINTS_BETWEEN_PROFILING_INFO_OUTPUT == 0) {
