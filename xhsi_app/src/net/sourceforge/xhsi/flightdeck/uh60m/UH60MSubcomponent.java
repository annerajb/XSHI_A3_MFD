...
public abstract class UH60MSubcomponent extends Subcomponent {

    UH60MGraphicsConfig empty_gc;


    public UH60MSubcomponent(ModelFactory model_factory, UH60MGraphicsConfig empty_gc) {
        super(model_factory, empty_gc);

        this.empty_gc = empty_gc;
    ...
    public UH60MSubcomponent(ModelFactory model_factory, UH60MGraphicsConfig empty_gc, Component parent_component) {
        this(model_factory, empty_gc);
