...
import net.sourceforge.xhsi.flightdeck.eicas.*;
...
public abstract class MFDSubcomponent extends Subcomponent {
...
//    XHSIPreferences preferences;
    ...
    public MFDSubcomponent(ModelFactory model_factory, MFDGraphicsConfig efb_gc) {
        super(model_factory, efb_gc);
    ...
    public MFDSubcomponent(ModelFactory model_factory, MFDGraphicsConfig efb_gc, Component parent_component) {
        this(model_factory, efb_gc);
...
//        gImg.setRenderingHints(efb_gc.rendering_hints);
