...
public abstract class Subcomponent extends Component {
    ...
    public Subcomponent(ModelFactory model_factory, GraphicsConfig gc) {
    ...
    public Subcomponent(ModelFactory model_factory, GraphicsConfig gc, Component parent_component) {
